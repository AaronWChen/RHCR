...
def main(_):
  ...
  tf_example = tf.io.parse_example(serialized=serialized_tf_example, features=feature_configs)
  ...
  prediction_classes = table.lookup(tf.cast(indices, dtype=tf.int64))
